...
| Competition                                                                                                          | Model Deployed                            | Best Score & Metric Used     | Higher/Lower = Better Predictions?    | Notebook                                         |
| -------------------------------------------------------------------------------------------------------------------- | ------------------------------------- | --------------- | ------- | ------------------------------------------------ |
...
| [Predicting Loan Payback](https://www.kaggle.com/competitions/playground-series-s5e11/overview) | Predict probability of loan repayment                 | **0.92012 [ROC-AUC](https://www.geeksforgeeks.org/machine-learning/auc-roc-curve/)** | Higher | [Notebook](./Predicting_Loan_Repayment/Predicting_Loan_Repayment.ipynb) |
